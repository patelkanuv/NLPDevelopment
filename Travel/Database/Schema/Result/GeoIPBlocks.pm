...
package Travel::Database::Schema::Result::GeoIPBlocks;

=head1 NAME

Travel::Database::Schema::Result::GeoIPBlocks - Is a basic class for GeoIPBlocks table.
...
__PACKAGE__->belongs_to('location_id' => 'Travel::Database::Schema::Result::GeoIPLocation');
=head1 LICENSE
