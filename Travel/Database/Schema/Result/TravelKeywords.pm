...
package Travel::Database::Schema::Result::TravelKeywords;

=head1 NAME

Travel::Database::Schema::Result::TravelKeywords -Is a basic class for travel_keywords table.
...
__PACKAGE__->table('travel_keywords');
