...
package Travel::Database::Schema::Result::GeoIPLocation;

=head1 NAME

Travel::Database::Schema::Result::GeoIPLocation - Is a basic class for GeoIPLocation table.
...
__PACKAGE__->has_many('location_blocks' => 'Travel::Database::Schema::Result::GeoIPBlocks', 'location_id');
