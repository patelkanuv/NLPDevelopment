...
package Travel::IPList::NorthAmerica::Store;

=head1 NAME

Travel::IPList::NorthAmerica::Store -Is a basic entity to North America Ip store.

=head1 SYNOPSIS

    use Travel::IPList::NorthAmerica::Store;
    my $cache       = Travel::IPList::NorthAmerica::Store->new();
...
A contructor method, no arguement. Initilise attributes
