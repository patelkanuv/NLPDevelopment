...
my $token1  = Travel::Air::Search::Tokens::Parser->new(
                data_str    => 'Tuna fishing off Jamaica in July',
                'IP'        => '113.20.16.231'
            );
$token1->parse_input;
...
cmp_ok($token1->depart_date, 'eq', '2013/07/01', 'depart_date_check');
...
cmp_ok($query->depart_date, 'eq', '2013/07/01', 'depart_date_check');
