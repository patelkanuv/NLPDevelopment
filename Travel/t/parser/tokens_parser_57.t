...
my $token1  = Travel::Air::Search::Tokens::Parser->new(
                data_str    => 'can i get the cheapest fares for los angeles starting sept 9 and returning sept 18',
                'IP'        => '113.20.16.231'
            );
$token1->parse_input;

my $date_parser = Utility::Date::Simple->new();
my $date1       = $date_parser->get_date_from_sentence('sept 9');
my $date2       = $date_parser->get_date_from_sentence('sept 18');
