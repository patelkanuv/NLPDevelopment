...
my $token1  = Travel::Air::Search::Tokens::Parser->new(
                data_str    => 'Visit Paris in the summer for two weeks',
                'IP'        => '113.20.16.231'
            );
$token1->parse_input;
...
cmp_ok($token1->return_date, 'eq', '2013/06/15', 'return_date_check');
...
cmp_ok($query->return_date, 'eq', '2013/06/15', 'return_date_check');
