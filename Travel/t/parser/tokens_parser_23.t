...
my $token1  = Travel::Air::Search::Tokens::Parser->new(
                data_str    => 'cheap flights toronto london july 18 to aug 3',
                'IP'        => '113.20.16.231'
            );
$token1->parse_input;
...
cmp_ok($token1->return_date, 'eq', '2013/08/03', 'return_date_check');
...
cmp_ok($query->return_date, 'eq', '2013/08/03', 'return_date_check');
