...
cmp_ok($token1->return_airport->[0]->airport_code, 'eq', 'CIA', '0_to_airport_code_check');
...
cmp_ok($query->to_airport->[0]->airport_code, 'eq', 'CIA', '0_to_airport_code_check');
