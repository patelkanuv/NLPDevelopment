...
my $token1  = Travel::Air::Search::Tokens::Parser->new(
                data_str    => 'three day visit lancaster pa march weekend of 15th',
                'IP'        => '113.20.16.231'
            );
$token1->parse_input;
...
#cmp_ok($token1->depart_date, 'eq', '2013/03/29', 'depart_date_check');
#cmp_ok($token1->return_date, 'eq', '2013/03/30', 'return_date_check');
...
#cmp_ok($query->depart_date, 'eq', '2013/03/29', 'depart_date_check');
#cmp_ok($query->return_date, 'eq', '2013/03/30', 'return_date_check');
