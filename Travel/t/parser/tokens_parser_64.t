...
my $token1  = Travel::Air::Search::Tokens::Parser->new(
                data_str    => 'Looking for trip to Italy mid June to end July',
                'IP'        => '113.20.16.231'
            );
$token1->parse_input;

my $date_parser = Utility::Date::Simple->new();
my $date1       = $date_parser->get_date_from_sentence('15th june');
my $date2       = $date_parser->get_date_from_sentence('25th july');
